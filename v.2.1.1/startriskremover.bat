...
cls
title setting up...
set pathprog=C:\program files\riskremover
cls
goto :checkfiles1
...
:start
cls
title -----Risk Remover v.2.1.1-----
echo Risk Remover:Program version 2.1.1 Database version 1.0.2015 SafeBrowser Database version 0.1.2015
pause
goto :menu2
:menu2
cls
...
cls
title Oops...
echo Sorry but our malware database is not enough to make a full scan.
echo.
echo Please use the quick scan for now.
echo.
pause
goto :menu
...
echo Risk Remover v 2.1.1 >> error404.txt
